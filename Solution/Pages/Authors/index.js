$(function () {
	...
	var authorService = window.acme.bookStore.authors.authors;
    ...
    if(abp.auth.isGranted('BookStore.Authors.Delete')) {
            ...
            $("#delete-selected-items").click(function () {
                if($("#select-all-items-btn").data("selected") === true) {
                    abp.message.confirm(l("DeleteAllRecords"), function (confirmed) {
                       ...
                       authorService.deleteAll(getFilter())
                           .then(function () {
                               dataTable.ajax.reloadEx();
                               selectOrUnselectAllCheckboxes(false);
                               showOrHideContextMenu();
                    ...
                    abp.message.confirm(l("DeleteSelectedRecords", selectedCheckboxes.length), function (confirmed) {
                        ...
                        authorService.deleteByIds(selectedRecordsIds)
                            .then(function () {
                                dataTable.ajax.reloadEx();
                                selectOrUnselectAllCheckboxes(false);
                                showOrHideContextMenu();
            ...
            function(result){
                    ...
                    var url =  abp.appPath + 'api/app/authors/as-excel-file' + 
                        abp.utils.buildQueryString([
                            ...
                            { name: 'birthDateMin', value: input.birthDateMin },
                            { name: 'birthDateMax', value: input.birthDateMax }, 
                            { name: 'shortBio', value: input.shortBio }
                            ]);
